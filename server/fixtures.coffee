if Chatrooms.find().count() is 0
  ...
  Chatrooms.insert
    ...
    user2: "EkECHjmAPigJEWt8F",
    link: "3t2sE8Q8JDqgNxq7XEkECHjmAPigJEWt8F",
    messages: [
      {
      ...
      {
        owner: "EkECHjmAPigJEWt8F",
        content: "hi I'm the other guy (Victor gor)",
        timestamp: 2345,
        read: false
      }
    ]
  ...
  Chatrooms.insert
    user1: "CenpBnvucf8fNGiYd",
    user2: "3t2sE8Q8JDqgNxq7X",
    link: "3t2sE8Q8JDqgNxq7XCenpBnvucf8fNGiYd",
    messages: [
      {
        owner: "CenpBnvucf8fNGiYd",
        content: "hi I'm Anniepoo",
        timestamp: 1234,
        read: false
      },
      {
        owner: "3t2sE8Q8JDqgNxq7X",
        content: "hi I'm the other guy (Michael)",
        timestamp: 2345,
        read: false
      }
    ]
  ...
  Chatrooms.insert
    user1: "EfD9W4oDfj8t5At5P",
    user2: "3t2sE8Q8JDqgNxq7X",
    link: "3t2sE8Q8JDqgNxq7XEfD9W4oDfj8t5At5P",
    messages: [
      {
        owner: "EfD9W4oDfj8t5At5P",
        content: "hi I'm Joe",
        timestamp: 1234,
        read: false
      },
  ...
  Chatrooms.insert
    user1: "KCFMWZFnzxutB9JkH",
    user2: "3t2sE8Q8JDqgNxq7X",
    link: "3t2sE8Q8JDqgNxq7XKCFMWZFnzxutB9JkH",
    messages: [
      {
        owner: "KCFMWZFnzxutB9JkH",
        content: "hi I'm Paul, I code really quickly!",
        timestamp: 1234,
        read: false
      },
      {
        owner: "3t2sE8Q8JDqgNxq7X",
        content: "hi I'm the other guy (Michael), I'm alright I guess",
        timestamp: 2345,
        read: false
      }
    ]
